...
import no.novari.fint.provider.fiks.state.CaseIdFactory
import no.novari.fint.provider.fiks.state.FaxShipmentFactory
import no.novari.fint.provider.fiks.state.FaxShipmentRepository
