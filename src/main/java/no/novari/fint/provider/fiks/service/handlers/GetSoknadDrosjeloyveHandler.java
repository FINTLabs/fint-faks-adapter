package no.novari.fint.provider.fiks.service.handlers;
...
import no.novari.fint.provider.fiks.exception.GetSakNotFoundException;
import no.novari.fint.provider.fiks.exception.GetSoknadDrosjeloyveNotFoundException;
import no.novari.fint.provider.fiks.service.fint.FaxQueryService;
import no.novari.fint.provider.fiks.service.fint.SoknadDrosjeloyveFactory;
...
public class GetSoknadDrosjeloyveHandler implements Handler {
    ...
    public void accept(Event<FintLinks> response) {
        ...
        } catch (GetSoknadDrosjeloyveNotFoundException | GetSakNotFoundException e) {
            response.setResponseStatus(ResponseStatus.REJECTED);
