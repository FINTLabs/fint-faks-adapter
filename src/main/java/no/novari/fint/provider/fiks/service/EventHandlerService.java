package no.novari.fint.provider.fiks.service;
...
import no.novari.fint.provider.adapter.event.EventResponseService;
import no.novari.fint.provider.adapter.event.EventStatusService;
import no.novari.fint.provider.fiks.SupportedActions;
import no.novari.fint.provider.fiks.service.fiks.FiksService;
import no.novari.fint.provider.fiks.service.handlers.Handler;
...
public class EventHandlerService {
    ...
    @Autowired
    private FiksService fiksService;
    ...
    private boolean healthCheck() {
        return handlers.stream().allMatch(Handler::health) && fiksService.healthy();
    }
