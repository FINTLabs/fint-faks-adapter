package no.novari.fint.provider.adapter.event;
...
import no.novari.fint.provider.adapter.FintAdapterEndpoints;
import no.novari.fint.provider.adapter.FintAdapterProps;
...
public class EventStatusService {
    ...
    public boolean postStatus(String component, Event event) {
        try {
            ...
            headers.add(HeaderConstants.CLIENT, "faks-adapter@" + event.getOrgId());
